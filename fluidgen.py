...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("fluid_sim.log"), logging.StreamHandler()]
)
...
def gen_fluid(input_data):
    ...
    class GeneratePositionTool(BaseTool):
        ...
        def _run(self, input: str) -> str:
            ...
            try:
                ...
                with open("fluid_simulation.json", "w") as json_file:
    ...
    class GenerateVelocityTool(BaseTool):
        ...
        def _run(self, input: str) -> str:
            ...
            try:
                ...
                if not os.path.exists("fluid_simulation.json"):
                    return "Error: fluid_simulation.json does not exist. Run GeneratePosition first."
                    
                with open("fluid_simulation.json", "r") as json_file:
    ...
    try:
        ...
        if os.path.exists("fluid_simulation.json"):
