...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("mpm_sim.log"), logging.StreamHandler()]
)
...
def gen_sim(input_data: str):
    ...
    save_path = os.path.join(os.getcwd(), 'Sim_Inputs')
    ...
    fluid_path = os.path.join(os.getcwd(), 'fluid_simulation.json')
    ...
    pc_path = os.path.join(os.getcwd(), 'preprocessed.ply')
