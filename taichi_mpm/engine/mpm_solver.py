...
class MPMSolver:
    ...
    def __init__(
        ...
        self.dx = size / res[0]  # yc: mesh size
        ...
        # Set default values in case parameter is not stored in input
        default_friction_angle = 40
        default_elastic_modulus = 2000000.0
        default_poisson_ratio = 0.3
        
        # Young's modulus and Poisson's ratio
        self.E, self.nu = input_vars.get("elastic_modulus", default_elastic_modulus), input_vars.get("poisson_ratio", default_poisson_ratio)
        # Lame parameters
        ...
        # Sand parameters
        friction_angle = math.radians(input_vars.get("friction_angle", default_friction_angle))
